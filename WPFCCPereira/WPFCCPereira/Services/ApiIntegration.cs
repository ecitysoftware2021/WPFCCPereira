            ...
            try
            {
                if (transaction != null)
                {
                    var response = await GetData(new RequestTransaction
                    {
                        ...
                        tipoidentificacioncliente = transaction.payer.TYPE_IDENTIFICATION.ToString(),
                        ...
                        nombre1cliente = transaction.payer.TYPE_IDENTIFICATION == 1 ? transaction.payer.NAME : string.Empty,
                        nombre2cliente = string.Empty,
                        apellido1cliente = transaction.payer.TYPE_IDENTIFICATION == 1 ? transaction.payer.LAST_NAME : string.Empty,
