            ...
            try
            {
                if (transaction != null)
                {
                    var response = await GetData(new RequestTransaction
                    {
                        ...
                        razonsocialcliente = transaction.payer.NAME,
                        nombre1cliente = transaction.payer.NAME,
                        nombre2cliente = transaction.payer.NAME,
                        apellido1cliente = transaction.payer.LAST_NAME,
                        apellido2cliente = transaction.payer.LAST_NAME,
                        emailcliente = transaction.payer.EMAIL,
                        direccioncliente = transaction.payer.ADDRESS,
                        telefonocliente = transaction.payer.PHONE.ToString(),
                        celularcliente = transaction.payer.PHONE.ToString(),
